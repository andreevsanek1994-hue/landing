...
export async function sendRegistrationEmail(data: RegistrationInput) {
  ...
  await transporter.sendMail({
    ...
    to: data.email,
    subject: "Спасибо за регистрацию! Мероприятие «Осень для танцев»",
    text: `Здравствуйте!\n\nСпасибо за регистрацию!\nВы зарегистрированы на мероприятие «Осень для танцев».\n\nДата: 10 сентября\nКонтактный телефон организатора: 8 905 376 45 34\n\nВаши данные:\nКоллектив: ${data.troupeName}\nКоличество человек: ${data.participantsCount}\nТелефон: ${data.phone}\nEmail: ${data.email}\n\nДо встречи на мероприятии!`,
    html: `
      <p>Здравствуйте!</p>
      <p><b>Спасибо за регистрацию!</b></p>\n      <p>Вы зарегистрированы на мероприятие <b>«Осень для танцев»</b>.</p>
